...
import { getListingsByLocation } from "../services/operations/listings";
...
function AllCards() {
  ...
  return (
    <div className="w-full min-h-[90vh]">
      {/* Top Filters Header */}
      <div className="w-full   text-lg border-b-2 flex justify-between items-center max-w-7xl px-5 mx-auto max-sm:flex-col-reverse max-sm:p-4 gap-y-3 ">
        <form
          onChange={(e) => setFilter(e.target.value)}
          className="  flex items-center justify-center gap-5 text-md mt-2 "
        >
          <section>
            <input
              type="radio"
          ...
          <section>
            ...
            >
              <div className="flex flex-col items-center justify-center p-2">
                <MdVapingRooms className=" text-xl md:text-3xl" />
                <div>Rooms</div>
              </div>
            </label>
          </section>
      ...
      {filteredListings?.length > 0 && (
        <div className="w-full mx-auto grid grid-cols-1  md:grid-cols-2 gap-5 text-nowrap p-5 py-5 pb-14  mt-5 max-w-[1200px]  ">
          {filteredListings?.map((item, i) => (
            ...
            >
              ...
              <section className="p-3 pb-4  border-b-2 border-dashed ">
                <div className="mb-2">
             ...
             <MdMessage className="text-2xl text-gray-400" />
              ...
              <section className="col-span-2 flex justify-end  pt-1 pb-2 pr-4 ">
      ...
      {filteredListings?.length === 0 && (
        <div>
          ...
          <p className="text-center text-2xl">
            No Result Found in this location.
          </p>
        </div>
      )}
    </div>
